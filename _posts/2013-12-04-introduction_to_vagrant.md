...
Créer rapidement un script shell nommé script_install.sh pour installer un serveur apache, un mysql et un tomcat. La commande `vagrant provision` permet de provisionner les machines.
